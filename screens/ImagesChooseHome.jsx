...
import ImageChoos from './ImageChoos';
import VidiosChoose from './VidiosChoose';


export default function ImagesChooseHome() {
  ...
  return (
    <View style={styles.contaner}>
      ...
      <ImageChoos show={showImages}/>
      <VidiosChoose show={showVidios}/>
    </View>
  );
}
